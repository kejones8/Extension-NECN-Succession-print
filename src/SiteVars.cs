...
namespace Landis.Extension.Succession.NECN
{
    ...
    public static class SiteVars
    {
        ...
        public static ISiteVar<int> HarvestDisturbedYear; //kj change
        public static ISiteVar<int> FireDisturbedYear;  //kj change
        ...
        public static void Initialize()
        {
            ...
            HarvestDisturbedYear = PlugIn.ModelCore.Landscape.NewSiteVar<int>(); //kj change
            FireDisturbedYear = PlugIn.ModelCore.Landscape.NewSiteVar<int>();  //kj change
        ...
        public static void InitializeDisturbances()
        {
            ...
            //SiteVars.HarvestDisturbedYear.SiteValues = false; //these added as comments kj
            //SiteVars.FireDisturbedYear.SiteValues = false;  //these added as comments kj
