    ...
    public class FireEffects
    {
        ...
        public static void ReduceLayers(byte severity, Site site)
        {
            ...
            try
            {
                ...
                //kate
                PlugIn.ModelCore.UI.WriteLine("   Fine litter reduction value for given severity is {0}", fineLitterReduction);
            ...
            //kate
            PlugIn.ModelCore.UI.WriteLine("   Carbon loss value is {0}", carbonLoss);
