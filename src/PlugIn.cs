        ...
        : Landis.Library.Succession.ExtensionBase
    {
        ...
        public void CohortPartialMortality(object sender, Landis.Library.BiomassCohorts.PartialDeathEventArgs eventArgs)
        {
            ...
            if (disturbanceType.IsMemberOf("disturbance:harvest"))
            {
                ...
                if (ModelCore.CurrentTime > SiteVars.HarvestDisturbedYear[site])  //kj change 12/10/2023
                {
                    HarvestEffects.ReduceLayers(SiteVars.HarvestPrescriptionName[site], site);
                    SiteVars.HarvestDisturbedYear[site] = ModelCore.CurrentTime; //added 12/10/23
                }
                ...
                //no line here for me to take out kj
            }
            if (disturbanceType.IsMemberOf("disturbance:fire"))
            {
                ...
                //if (!Disturbed[site]) // this is the first cohort killed/damaged /kj change 12/10/2023
                if (ModelCore.CurrentTime > SiteVars.FireDisturbedYear[site]) //kj added
                {
                    ...
                    if (SiteVars.FireSeverity != null && SiteVars.FireSeverity[site] > 0)
                        FireEffects.ReduceLayers(SiteVars.FireSeverity[site], site);
                         ...
                         SiteVars.FireDisturbedYear[site] = ModelCore.CurrentTime; //added kj
        ...
        public void CohortTotalMortality(object sender, Landis.Library.BiomassCohorts.DeathEventArgs eventArgs)
        {
            ...
            if (disturbanceType != null)
            {
                ...
                if (disturbanceType.IsMemberOf("disturbance:fire"))
                {
                    ...
                    //if (!Disturbed[site])  // the first cohort killed/damaged //kj change
                    if (ModelCore.CurrentTime > SiteVars.FireDisturbedYear[site])
                    {
                        SiteVars.SmolderConsumption[site] = 0.0;
                        SiteVars.FlamingConsumption[site] = 0.0;
                        if (SiteVars.FireSeverity != null && SiteVars.FireSeverity[site] > 0)
                            ...
                            SiteVars.FireDisturbedYear[site] = ModelCore.CurrentTime; //kj added
                    ...
                    //no lin here for me to remove kj
                }
                else
                {
                    if (disturbanceType.IsMemberOf("disturbance:harvest"))
                    {
                        ...
                        if (ModelCore.CurrentTime > SiteVars.HarvestDisturbedYear[site])  //kj change
                        {
                            HarvestEffects.ReduceLayers(SiteVars.HarvestPrescriptionName[site], site);
                        }
